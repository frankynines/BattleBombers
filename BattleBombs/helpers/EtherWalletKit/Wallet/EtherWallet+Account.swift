...
extension EtherWallet: AccountService {
    ...
    public func importAccount(privateKey: String, password: String) throws {
        ...
        guard let keystore = try EthereumKeystoreV3(privateKey: privateKeyData, password: password, aesMode: "aes-128-ctr") else {
            throw WalletError.malformedKeystore
        }
    ...
    private func saveKeystore(_ keystore: EthereumKeystoreV3) throws {
        ...
        let userDir = KeystoreHelper.shared.sharedContainerURL().path
